...
const projects = [
  ...
  {
    id: 'edTech',
    title: 'Education platform for kids',
    description: 'Acellus Gold includes cutting-edge features designed to accelerate learning',
    image: '/projects/acellusacademy.png',
    imageGradient: 'from-rose-500 to-pink-600',
    tags: ['Wordpress', 'Python', 'AI', 'Machine Learning'],
    category: 'AI/ML',
    status: 'Completed',
    timeline: '3 months',
    year: '2020',
    client: '',
    featured: true,
    links: [{ type: 'live', url: 'https://acellusacademy.com/' }],
  },
  {
  ...
  {
    id: 'e-commerce-website1',
    title: 'E-commerce Website for Cleaning',
    description: 'Office cleaning, Post construction cleaning, Airbnb cleaning',
    image: '/projects/vagncleaningservices.png',
    imageGradient: 'from-rose-500 to-pink-600',
    tags: ['WordPress', 'Stripe'],
    category: 'E-commerce',
    status: 'Completed',
    timeline: '1 months',
    year: '2024',
    client: '',
    featured: true,
    links: [{ type: 'live', url: 'https://vagncleaningservices.com/' }],
  },
  {
    id: 'e-commerce-website2',
    title: 'E-commerce Website for shopping coffee',
    description: 'Developed with shopify for shopping vietnamese coffe from ceremonial beans',
    image: '/projects/cafely.png',
    imageGradient: 'from-rose-500 to-pink-600',
    tags: ['Shopify'],
    category: 'E-commerce',
    status: 'Completed',
    ...
    client: '',
    featured: true,
    links: [{ type: 'live', url: 'https://cafely.com/' }],
  },
  {
    id: 'e-commerce-website3',
    title: 'E-commerce Website for shopping Swimsuit, Bra, Lingerie, Sleepwear, Slip',
    description: 'New York City’s Favorite Online Luxury Lingerie Store',
    image: '/projects/townshop.png',
    imageGradient: 'from-rose-500 to-pink-600',
    tags: ['Shopify'],
    category: 'E-commerce',
    status: 'Completed',
    ...
    client: '',
    featured: true,
    links: [{ type: 'live', url: 'https://townshop.com/' }],
  },
  {
    id: "mobile-app-development",
    title: 'Taxi Booking App',
    description: 'Offers instant and future booking services for various types of rides, including taxis, carpooling, local and outstation trips, and shuttle services.',
    image: '/projects/RiaCab.png',
    imageGradient: 'from-rose-500 to-pink-600',
    tags: [ 'iOS', 'Firebase'],
    category: 'Mobile',
    status: 'Completed',
    ...
    client: '',
    featured: true,
    links: [{ type: 'live', url: 'https://apps.apple.com/us/app/riacab-customer/id1531171066' }],
  },
   {
    id: "mobile-app-development2",
    title: 'ICE50 - Dental Education',
    description: 'Ice50 is the first and only ADA / CDA C.E.R.P.-approved video dental continuing education with live chat so you can get all 50 CE credits required in iPhone and web platforms:',
    image: '/projects/ICE50.png',
    imageGradient: 'from-rose-500 to-pink-600',
    tags: ['React Native', 'Firebase', 'Repo'],
    category: 'Mobile',
    status: 'Completed',
    timeline: '3 months',
    year: '2023',
    client: '',
    featured: true,
    links: [{ type: 'live', url: 'https://apps.apple.com/in/app/ice50-dental-education/id1077994770' }],
  }
]

const categories = ['All', 'Full-Stack', 'AI/ML', 'Research', "E-commerce", "Mobile"]
